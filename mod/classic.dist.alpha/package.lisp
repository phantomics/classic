;;; ============================================================
;;; classic.dist.alpha — reference distribution package
;;; ============================================================
;;;
;;; This is a distribution package conveying Classic's prime
;;; reference implementation, making its combined API available
;;; to users by way of this one package.

(defpackage #:classic.dist.alpha
